...
//petSalon.pets.push(pet1,pet2,pet3); // moving this down to line 67 , we want to wait until html is rendered firt . We want to control what we want javascript to do in order or in command.
...
//Professor suggested , this is more organized and easier access
function clearForm(){
    inputName.value="";
    inputAge.value="";
    inputGender.value="";
